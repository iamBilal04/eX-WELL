  ...
  return (
    <>
      {loading ? (
        ...
        <div className="sm:w-[32rem] shadow-blue-100 mx-auto my-36 overflow-hidden rounded-2xl bg-white shadow-lg sm:max-w-lg items-center m-5">
          ...
          <div className="space-y-4 px-8 py-10">
            ...
            <button
              className="mt-4 rounded-full bg-blue-600 px-10 py-2 font-semibold text-white hover:bg-blue-400"
              type="submit"
              onClick={prediction}
            >
              Submit
